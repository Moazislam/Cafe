...
export function Dashboard() {
  ...
  return (
    <div className="page-stack">
      ...
      <section className="split-section"><div className="section-heading"><div><h2>Room floor</h2><p>Start and stop sessions as rooms change hands.</p></div><button className="text-action" type="button" onClick={() => navigate("/rooms")}>View rooms <ArrowUpRight size={16} /></button></div><RoomGrid {...cafe} onStart={requestStart} onEnd={checkout.openCheckout} onCancel={cancelActiveSession} onReserve={(roomId) => navigate(`/reservations?room=${roomId}`)} /></section>
